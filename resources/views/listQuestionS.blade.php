                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h1 class="h3 m-0 font-weight-bold text-primary">List of Questions</h1>
                        </div>
                        <br>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href={{ url('viewQuestionS/' . $question->questionId) }} class="btn btn-warning btn-circle btn-sm"><i class="fa fa-search"></i></a>
                                                <a href="{{ url('questionAnswer/' . $question->questionId) }}" class="btn btn-success  btn-sm"><i class="bi bi-pencil-fill"> Answer</i></a>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="8"> {{ $message }}No data available</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                    <tfoot>
