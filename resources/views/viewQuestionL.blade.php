...
<html lang="en">
    <head>
        ...
        <title>View Question-Lecturer</title>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <div class="text-right">
                                    <button type="submit" class="btn btn-success" data-mdb-ripple-color="dark"  onclick="window.location.href = '{{ route('listQuestionL') }}'">Return</button>
                                </div>
                            </div>
                            <div class="card-body">
                                @if (session('success'))
                                    ...
                                    <div id="row">
                                        ...
                                        <div class="row row-cols-2">
                                            <div class="col mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" id="formulaName"  value="{{ $questionStep->formula->formulaName ?? 'N/A' }} , {{ $questionStep->formula->formula ?? 'N/A' }}" name="formulaName"
                                                        class="form-control" aria-describedby="basic-addon3" readonly />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" id="answer" step="0.0001"  value="{{ $questionStep->answer ?? 'N/A' }}" name="answer"
                                                        class="form-control" aria-describedby="basic-addon3" readonly />
                                                </div>
                                            </div>
                                        </div>
